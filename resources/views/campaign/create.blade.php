            ...
            <div class="clo-xs-12 colsm-2 col-md-2 col-lg-2">
                <div class="list-group" id="leftMenu">
                    <div class="leftMenu">
                        ...
                        <a href="create_campaign_contact.html" id="leftMenuLianxiren" class="list-group-item">相关联系人</a>
                        <a href="create_campaign_organization.html" id="leftMenuZuzhi" class="list-group-item">相关组织</a>
            ...
            <div class="clo-xs-12 col-sm-10 col-md-10 col-lg-10" id="panel1">
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                        <form method="post" action="{{ URL('campaign') }}" role="form">
                            <table class="table table-bordered">
                                <tr>
                                    <td>名称</td>
                                    <td><input type="text" class="form-control" name="campaign_name" id="campaign_name"></td>
                                    <td>类型</td>
                                ...
                                <tr>
                                    ...
                                    <td>预算</td>
                                    <td><input type="text" class="form-control" name="budget" id="budget"></td>
                                </tr>
                                <tr>
                                    <td>价值</td>
                                    <td>
                                    ...
                                    <td>期待汇报</td>
                                    <td><input type="text" class="form-control" name="expected_revenue" id="expected_revenue"></td>
                                </tr>
                                <tr>
                                    <td>预计结束日期</td>
                                    <td><input type="text" class="form-control" name="expected_close_data" id="expected_close_data" ></td>
                                    <td >负责人</td>
                                    <td>
                            ...
                            <div class="form-btn-align">
                                ...
                                <button type="button" class="btn btn-default" href="{{asset('/campaign')}}">取消</button>
                            </div>
                        </form>
                    </div>
                </div>
